...
class HomeViewModel : ViewModel() {
    val recipes = listOf(Recipe("Mac & Cheese", listOf(), 0, "This is the descriptions for Mac And Cheese"),
    ...
    private val recipe = MutableLiveData<MutableList<Recipe>>().apply {
        value = mutableListOf(Recipe("Mac & Cheese", listOf(), 0, "This is the descriptions for Mac And Cheese"),
            Recipe("Chocolate Chip Cookies", listOf(), 325, "This recipe is for the best CCC. Melt in your mouth."),
            Recipe("Popcorn", listOf(), 250, "Pop it!")
        )
    }
